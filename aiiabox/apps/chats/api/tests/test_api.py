"""
Comprehensive tests for Chat and Message API endpoints.

Tests cover:
- Authentication (token required, invalid tokens rejected)
- Authorization (users can only access own chats/messages)
- CRUD operations for both ChatViewSet and MessageViewSet
- Input validation (title, content, role)
